                    ...
                    <Form onSubmit={handleSubmit} autoComplete="off" >
                        ...
                        <Box style={{ padding: '1rem 1rem 0 1rem' }}>
                            ...
                            <div className="form-group">
                                ...
                                <MyTextField fullWidth name="members" variant="outlined" size="small" placeholder="Add members to this project"
                                    onChange={handleChange} onBlur={handleBlur}
                                    ...
                                    <MenuItem value={'nidhal'}>
                                        Nidhal Bettaibi
                                    </MenuItem>
                                    <MenuItem value={'maher'}>
                                        Maher Bettaibi
                                    </MenuItem>
                                    <MenuItem value={'ridha'}>
                                        Ridha Bettaibi
                                    </MenuItem>
                                </MyTextField>
                            </div>
